...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/expat-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/expat-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add expat libexpat
# for installing globally
pixi global install expat libexpat
```
...
It is possible to list all of the versions of `expat` available on your platform:
...
```
pixi search expat --channel conda-forge
```
